...
// #include "ocs2_legged_robot/common/Types.h" // Suqin
// #include "ocs2_legged_robot/synchronized_module/SwitchedModelReferenceManager.h" // Suqin
#include "ocs2_legged_robot_annotated/common/Types.h" // Suqin
...
class FootPlacementConstraint final : public StateInputConstraint {
 public:
  ...
  //     scalar_t time, const vector_t& state, const vector_t& input,
  //     const PreComputation& preComp) const override; // Suqin
